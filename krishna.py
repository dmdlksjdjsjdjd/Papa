...
bot = telebot.TeleBot('7721045989:AAGllMHRpYkPznW1TeGWoMhoJ3BGkyLUCB0')

# Admin user IDs
admin_id = {"7868530718", "6406776405", "1600832237"}
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to krishna Home, {user_name}! Feel Free to Explore.
